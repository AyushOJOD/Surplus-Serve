...
const page = () => {
  ...
  return (
    <AnimateWrapper dir={-10}>
      <section className="">
        <div className="relative w-full dark:bg-black bg-white px-6 md:pt-5 pb-8 my-8 md:shadow-xl sm:mx-auto sm:max-w-2xl sm:rounded-lg sm:px-10">
